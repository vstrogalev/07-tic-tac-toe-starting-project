...
function App() {
  ...
  for(const combination of WINNING_COMBINATIONS) {
    const firstWinnerSymbol = gameBoard[combination[0].row][combination[0].column];
    const secondWinnerSymbol = gameBoard[combination[1].row][combination[1].column];
    const thirdWinnerSymbol = gameBoard[combination[2].row][combination[2].column];

    if (firstWinnerSymbol && firstWinnerSymbol === secondWinnerSymbol && firstWinnerSymbol === thirdWinnerSymbol) {
